...
public class PexelsImageSearch {
    ...
    private static final String API_KEY = "KSzgVZQNcDAoLo8mAROd1kuuJkMHacNLGK4Y3kVFhUTZZPLv6KmaJW2n";
    private static final String ENDPOINT = "https://api.pexels.com/v1/search";

    private static final String BAIDU_APP_ID = "20250213002272934";
    private static final String BAIDU_API_KEY = "nvNZbEl80_TxSt_2aNyJ";
